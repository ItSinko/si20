...
<?php
 ...
 header("content-disposition: attachment;filename=Laporan_Keuangan_(Offline).xls");
...
<br>
	<div class="horizon">
	<h3>Data Penjualan (SPA Offline) - PT. SINKO PRIMA ALLOY</h3>
      <table class="tes" id="tabelExport" border="1">
        ...
        <tr>
								...
								<th width=1% bgcolor="#f3ffe5">Peti Peti</th>						
								<th width=1% bgcolor="#f3ffe5">Lain Lain</th>						
					</tr>
       </thead>
		<tbody>
...
$a= 1;
$result=mysqli_query($con,"SELECT *,  harga_off * jumlah_off as total  ,(harga_off * jumlah_off) * diskonacc_off / 100 as diskon
															,(harga_off * jumlah_off) - ((harga_off * jumlah_off) * diskonacc_off / 100)  as faktur
															...
															,(((harga_off * jumlah_off) - ((harga_off * jumlah_off) * diskonacc_off / 100)) / 1.1 )* 0.015 as pph
																		 ...
																		 LEFT JOIN acc_off ON acc_off.idorderacc_off = admjual_off.idorderadm_off
        ...
        echo'<tr class="task-list-row"
		 ...
		 data-nmprd="'.$row['nam_prod'].'"
			...
			<td >'.$a++.'</td>			
									...
									<td class=nodo>'.number_format($row['pph']).'</td>	
