...
<legend class="legend_form">Info Produk</legend>
  ...
  <div class="form-group row">
	...
	<div class="col-sm-1 ">
	<select id="distributor" class="selectpicker" type="text"  name="distributor"  data-live-search="true" title="Distributor"   onchange="changeDbs(this.value);rp();count();" required> 
	...
	<div class="col-sm-1 ">
	<select id="kategori" class="selectpicker" type="text"  name="distributor"  title="Kategori"   onchange="changeDbs(this.value);rp();count();" required> 
    ...
    <div class="col-sm-2 ">
      <select id="type" class="form-control " style="width: 200px;" onchange="changeValue(this.value);rp();count();" name="type"  required> 
		<option value="disabled">Pilih Produk</option>	
		<?php 
...
$("#form-contact").submit(function(e) {
	...
	{	
		...
		$.ajax({
			...
			data: "nolkpp="+nolkpp+"&jumlah="+jumlah+"&harga="+harga+"&satuan="+satuan+"&tgledit="+tgledit+"&noaks="+noaks+"&ongkir="+ongkir+"&deskripsi="+deskripsi+"&instansi="+instansi+"&status="+status+"&tglbuat="+tglbuat+"&ket="+ket+"&diskonspa="+diskonspa+"&diskonujispa="+diskonujispa+"&pabrik_on="+pabrik_on+"&idprod_on="+idprod_on+"&expdates="+expdates+"&distributor="+distributor,
