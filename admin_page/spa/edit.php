...
<legend class="legend_form">Info Produk</legend>
  ...
  <div class="form-group row">
	...
	<div class="col-sm-2 ">
	<select id="distributor" class="selectpicker" type="text"  name="distributor"  data-live-search="true"   onchange="changeDbs(this.value);rp();count();" required> 
...
$("#form-contact").submit(function(e) {
	...
	{	
		...
		$.ajax({
			...
			data: "nolkpp="+nolkpp+"&jumlah="+jumlah+"&harga="+harga+"&satuan="+satuan+"&tgledit="+tgledit+"&noaks="+noaks+"&ongkir="+ongkir+"&deskripsi="+deskripsi+"&instansi="+instansi+"&status="+status+"&tglbuat="+tglbuat+"&ket="+ket+"&diskonspa="+diskonspa+"&diskonujispa="+diskonujispa+"&pabrik_on="+pabrik_on+"&idprod_on="+idprod_on+"&expdates="+expdates+"&no="+no+"&ket_log="+ket_log+"&username="+username,
