...
<?php
 ...
 header("content-disposition: attachment;filename=Laporan_Pengiriman_(SPA_Online).xls");
...
<br>
	...
	<div class="horizon">
	<h3>Laporan Pengiriman (SPA Online) - PT. SINKO PRIMA ALLOY</h3>
		 ...
		 <tr> 
          ...
          <th colspan="3" style="width:  15.33%;   font-size:20px;"  class="align-middle" >Ekspedisi / Pengiriman</th>
                                ...
                                <tr data-control-type="sort-buttons-group"
									...
									<th width=1% class="text-center" bgcolor="#ffe0ad">No LKPP</th>
						...
						echo'
                            <tbody>
								...
								if (empty($nopo))  { 
									...
									echo '<td class=nopo >'.$row['nopo_on'].'</td>';
												}
									...
									echo '<td class=tglpo >'.$row['tglpo_on'].'</td>';
												}		
									...
									echo '<td class=nodo >'.$row['nodo_on'].'</td>';
												}		
								...
								if (empty($tgldo))  { 
									...
									echo '<td class=tgldo >'.$row['tgldo_on'].'</td>';
												}		
									...
									echo '<td class=nosj >'.$row['nosj_on'].'</td>';
												}			
									...
									echo '<td class=tglsj >'.$row['tglsj_on'].'</td>';
												}	
							...
							if (empty($eks))  { 
									...
									echo '<td class=noresi >'.$row['noresi_on'].'</td>';
												}		
