				...
				<!-- panel -->
					<div class="jplist-panel box panel-top">						
                        ...
                        <div 
						   ...
						   <button class="btn btn-primary"   onclick="location.href='./index.php?hlm=accon&aksi=baru'">Tambah Data</button>
					</div>		
 <!-- data --> 
		...
		$result=mysqli_query($con,"SELECT   * ,harga_on * jumlah_on as total
                            ...
                            <tbody>                      
                                <tr class=tbl-item>
									...
									<td>'.$row["ketaccon"].'</td>';
									?>			
								   <td><a href="?hlm=accon&aksi=edit&nolkppacc_on=<?=$row["nolkppacc_on"]; ?>" class="cus-application_form_edit"></a> |
								 	<a href="#" type="button" class="cus-cross" data-toggle="modal" data-target="#myModal<?php echo $row["nolkppacc_on"] ?>"></a> 
								   </td>	 
								</tr>
