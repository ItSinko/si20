...
<div id="slide_home" class="carousel slide" data-ride="carousel">
  ...
  <h5 class="display-5">Selamat datang <?php echo $_SESSION['username']; ?>, </h5>
  <p class="lead">Sistem Informasi Kontrol Penjualan</p>
  <hr class="my-4">
  
<small class="pull-left" align="center"> IT Team © 2020 | PT Sinko Prima Alloy </small>
</div>
<img class="d-block w-50" src="bg_image\Poster_6.jpg" alt="Second slide" style="position: relative; left: 20%;"> 
    </div>
