...
$newID = sprintf("%01s",$nourut);
	...
	//memasukan data
$query= "INSERT INTO spa_on (no_on, nolkpp_on, noaks_on, despaket_on, instansi_on, satuan_on,status_on,tgl_buat_on,tgl_edit_on,jumlah_on,harga_on,ongkos_on,diskon_nota_on,diskon_uji_on,temphari_on,ket_on,idprod_on,pabrik_on) VALUES ('$newID','$nolkpp','AKN-P$noaks','$deskripsi','$instansi','$satuan','$status','$tglbuat','$tgledit','$jumlah','$hargaprd','$ongkirprd','$diskonspa','$diskonujispa','$expdates','$ket','$idprod_on','$pabrik_on')";  
