...
$("#check").submit(function(e) {
	...
	if(type == "" || namaprd == "" || kategori == "" || harga == "" || hargadpp == ""|| namacoo == "" || satuan == "") {
		...
		$.ajax({
			...
			data: "kode="+kode+"&merk="+merk+"&type="+type+"&namaprd="+namaprd+"&kategori="+kategori+"&noakd="+noakd+"&jatuhakd="+jatuhakd+"&harga="+harga+"&hargadpp="+hargadpp+"&namacoo="+namacoo+"&ket="+ket+"&satuan="+satuan,
