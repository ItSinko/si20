...
$con=mysqli_connect("localhost","root","sinko95","db_20");
...
//COO
$pdf->Image('background_coo.jpg',0,0,210);
...
$pdf->SetY( 62 );
$pdf->SetX( 28 );
$pdf->Write('15','Kementrian Kesehatan Nomor : KEMENKES RI AKD 20403710512');
